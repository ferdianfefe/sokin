    ...
    <DefaultLayout location="pesan">
      <div className="flex flex-col justify-between min-h-screen relative">
        <div className="px-4">
          ...
          <div className="bg-c-orange-200 flex items-center justify-evenly py-2 px-3 rounded-3xl mb-8 shadow-[0_3px_3px_0.1px_rgb(400,100,0,0.3),inset_0_3px_6px_10px_rgb(500,500,500,0.3)]">
            ...
            <p className="text-c-orange-800 text-2xl font-semibold ">
