  ...
  return (
    <DefaultLayout location="akun">
      <div className="relative h-screen py-10 px-8">
        ...
        <Input text="Nama" className="mb-6" defaultValue={profile?.name} type="disabled"/>
        {/* <Input
          text="Nomor Telepon"
          className="mb-6"
          ...
          imagePosition="right"
        /> */}
        <Input text="Email" className="mb-6" defaultValue={profile?.email} type="disabled"/>
        <Input text="Password" className="mb-6" type="disabled" defaultValue="********"/>
        <Button
          text="Keluar"
          type="red"
