  ...
  return (
    <div className={`${className} w-full`}>
      ...
      <div className="mt-1 relative">
        {type === "dropdown" ? (
          <div
            className={`shadow-[-2px_2px_3px_0.1px_rgb(100,100,0,0.3)] rounded-[20px]`}
          >
            <select
              name="menu-category"
              id="merchant-category"
              className="className={` bg-[#FFF0E0] text-orange-800 font-semibold pl-8 w-full rounded-[20px] h-8 `}"
            >
